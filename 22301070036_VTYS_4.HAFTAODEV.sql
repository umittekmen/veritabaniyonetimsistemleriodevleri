...
(2,3,'Zile'	,'açýldý'),
(3,4,'Turhal',	'kapandý'),
(4,7,'Amasya','Üye kaydý için merkez');

	INSERT INTO KITAPLAR
VALUES
('6051961436',	'þemboller ve iþaretler','2010-02-02','352'),
('6053950899',	'türk eðitim ve tarih','2010-01-01','262'),
('6053953135',	'geliþim ve psikolojisi','2010-01-01','290'),
('6054125234',	'zazalar ve türklük','2010-01-01','264'),
('6055813185','þifreler','2009-08-03','288'),
('6055882334','28 günde kuantum','2009-08-03','248'),
('6055937065','bigisayarlý muhasebe','2009-04-05','358'),
('6055937157','bilgisayar ve int kullanýmý','2009-12-03','410'),
('6055937188,','autocad 2009','2009-01-26','396'),
('605593730','ticari matematik','2010-02-02','390'),
('6055937515','algoritma ve prog giriþ','2009-07-01','306'),
...
('9758874095','fak. için genel mat','2007-01-01','226');
...
USE KITAP_KUTUPHANE;
 INSERT INTO UYELER
 VALUES 
 ('Ümit', 'TEKMEN', 1,'5078819042', 'uumit380@gmail.com',10);
 

 UPDATE UYELER
 SET uyeAdi='Muhammet Ümit'
 where uyeAdi='Ümit';
